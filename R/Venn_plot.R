...
#' @param Euler.dist Boolean indicating whether to draw Euler diagrams when conditions are met or not (Venn Diagrams with moveable circles)
...
#' @details This function will automatically learn how many treatments or categories are to be depicted, in case of treatments > 4 a multilayer circle plot will be provided
