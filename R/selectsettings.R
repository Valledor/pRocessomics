...
#### Setting file exists
  if(exists(paste(originaldatasetname,"_dsettings",sep=""), envir = .GlobalEnv)==TRUE){
    ...
    writeLines(answ, con = stdout(), sep = "\n", useBytes = FALSE) 
  ...
  writeLines(treatment1col, con = stdout(), sep = "\n", useBytes = FALSE) 
  ...
  writeLines(treatment2col, con = stdout(), sep = "\n", useBytes = FALSE) 
  ...
  writeLines(initialcolumn, con = stdout(), sep = "\n", useBytes = FALSE) 
  ...
  writeLines(initialrow, con = stdout(), sep = "\n", useBytes = FALSE) 
