...
RemoveEmptyColumns_univar<-function(matriz, initialrow, initialcolumn){
  matrizfiltrada<-as.data.frame(matriz[initialrow:nrow(matriz),initialcolumn:ncol(matriz)])
